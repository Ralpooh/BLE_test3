package rlp.somuna.ble_test3.adapters;
...
public class BleDevicesAdapter extends BaseAdapter {
    ...
    private final Map<BluetoothDevice, String> rssiMap = new HashMap<>();
    ...
    public void setDevices(Map<BluetoothDevice, String> devices) {
        rssiMap.clear();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.list_device, viewGroup, false);
        ...
        */
		...
		// M2CLOUD START
        final String rssi = rssiMap.get(device);
        viewHolder.signal.setText(rssi);
		// M2CLOUD END
